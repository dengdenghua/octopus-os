...
class ParagraphData:
    ...
    def __init__(self, paragraph: Any):
        ...
        if (
            ...
            pPr = paragraph._p.pPr  # noqa: N806
...
class ShapeData:
    ...
    def __init__(
        ...
        if hasattr(shape, "is_placeholder") and shape.is_placeholder and shape.placeholder_format and shape.placeholder_format.type:  # type: ignore
