...
class PythonAnalyzer:
    ...
    def _check_style(self):
        ...
        for i, line in enumerate(self.lines, 1):
            ...
            if len(line) > 100:
                self.issues.append(
                    CodeIssue("style", "info", i, f"Line too long ({len(line)} > 100 characters)")
                )
    ...
    def _check_best_practices(self):
        ...
        for i, line in enumerate(self.lines, 1):
            ...
            if re.search(r"==\s*None|None\s*==", line):
                self.issues.append(
                    CodeIssue("style", "info", i, "Use 'is None' instead of '== None'")
                )

            # Check for != None instead of is not None
            if re.search(r"!=\s*None|None\s*!=", line):
                self.issues.append(
                    CodeIssue("style", "info", i, "Use 'is not None' instead of '!= None'")
                )
    ...
    def _check_security(self):
        ...
        for i, line in enumerate(self.lines, 1):
            ...
            if (
                ...
                and ("SELECT" in line.upper() or "INSERT" in line.upper())
            ):
                self.issues.append(
                    CodeIssue(
                        "security",
    ...
    def _check_style(self):
        ...
        for i, line in enumerate(self.lines, 1):
            ...
            if "==" in line and "===" not in line and "!==" not in line:
                self.issues.append(
                    CodeIssue("style", "info", i, "Use '===' instead of '==' for strict equality")
                )
    ...
    def _check_best_practices(self):
        ...
        for i, line in enumerate(self.lines, 1):
            ...
            if "console.log" in line:
                self.issues.append(
                    CodeIssue("style", "info", i, "console.log found - remove before production")
                )
...
class CodeMetrics:
    ...
    def calculate(self) -> dict[str, Any]:
        ...
        code_lines = sum(
            1 for line in self.lines if line.strip() and not line.strip().startswith("#")
        )
