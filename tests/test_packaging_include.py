...
_REQUIRED_RUNTIME_WHEEL_FILES = {
    ...
    "runtime/execution/tool_engine/host_tool_broker.py",
    "runtime/execution/tool_engine/host_mcp.py",
    "runtime/execution/host_mcp_connection.py",
    "runtime/execution/opencode_backend.py",
    "runtime/execution/opencode_roles.py",
    "runtime/execution/agents/team_patterns.py",
    "runtime/execution/agents/collaboration_quality.py",
    "runtime/execution/tool_engine/role_instructions.py",
    ...
    "runtime/sensing/gateway/realtime_execution.py",
    "runtime/sensing/gateway/realtime_execution_context.py",
    "runtime/sensing/gateway/realtime_opencode_backend.py",
