...
RENAMES = {
    "runtime.sensing.server.docker": "runtime.sensing.server.docker",
    "runtime.sensing.server.k8s": "runtime.sensing.server.k8s",
    "runtime.sensing.server.ssh": "runtime.sensing.server.ssh",
    "runtime.sensing.server.subprocess_backend": "runtime.sensing.server.subprocess_backend",
    # Bare relative-import or re-export references in __init__.py-style files
    ".docker": ".docker",
    ".k8s": ".k8s",
    ".ssh": ".ssh",
